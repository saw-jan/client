Feature: Sharing
    ...
    Scenario: sharing file/folder with a user that has special characters as username
        ...
        When the user adds "Speci@l_Name-.+" as collaborator of resource "textfile.txt" with permissions "edit,share" using the client-UI
    ...
    Scenario: Collaborator should not see to whom a file is shared.
        ...
        When the user opens the sharing dialog of "Shares/textfile0.txt" using the client-UI
    ...
    Scenario: User (non-author) can not share to a group to which the file is already shared
        ...
        And user "Brian" has set up a client with default settings
        When the user tires to share resource "Shares/textfile0.txt" with the group "grp1" using the client-UI
    ...
    Scenario: sharee edits content of a file inside of a shared folder shared by sharer
        ...
        And user "Brian" has set up a client with default settings
        When the user overwrites the file "Shares/simple-folder/textfile.txt" with content "overwrite ownCloud test text file"
        Then as "Brian" the file "Shares/simple-folder/textfile.txt" on the server should have the content "overwrite ownCloud test text file"
    ...
    Scenario: sharee creates a file and a folder inside a shared folder
        ...
        And user "Brian" has set up a client with default settings
        When the user waits for folder "Shares/Parent" to be synced
        And user "Brian" creates a file "Shares/Parent/localFile.txt" with the following content inside the sync folder
            """
            test content
            """
        And user "Brian" creates a folder "Shares/Parent/localFolder" inside the sync folder
        And the user waits for file "Shares/Parent/localFile.txt" to be synced
        And the user waits for folder "Shares/Parent/localFolder" to be synced
        Then as "Brian" file "Shares/Parent/localFile.txt" should exist on the server
        And as "Brian" folder "Shares/Parent/localFolder" should exist on the server
    ...
    Scenario: sharee tries to edit content of a file inside of a shared folder without write permission
        ...
        And user "Brian" has set up a client with default settings
        When the user tries to overwrite the file "Shares/Parent/textfile.txt" with content "overwrite ownCloud test text file"
        Then as "Brian" the file "Shares/Parent/textfile.txt" on the server should have the content "ownCloud test text file"
    ...
    Scenario: sharee edits content of a file shared by sharer
        ...
        And user "Alice" has shared file "textfile.txt" on the server with user "Brian" with "all" permissions
        And user "Brian" has set up a client with default settings
        When the user overwrites the file "Shares/textfile.txt" with content "overwrite ownCloud test text file"
        Then as "Brian" the file "Shares/textfile.txt" on the server should have the content "overwrite ownCloud test text file"
    ...
    Scenario: sharee tries to edit a file shared without write permission
        ...
        And user "Brian" has set up a client with default settings
        When the user tries to overwrite the file "Shares/textfile.txt" with content "overwrite ownCloud test text file"
        Then as "Brian" the file "Shares/textfile.txt" on the server should have the content "ownCloud test text file"
    ...
    Scenario: reshare a file/folder
        ...
        And user "Alice" has shared file "textfile.txt" on the server with user "Brian" with "all" permissions
        And user "Brian" has set up a client with default settings
        When the user adds "Carol King" as collaborator of resource "Shares/FOLDER" with permissions "edit,share" using the client-UI
        And the user adds "Carol King" as collaborator of resource "Shares/textfile.txt" with permissions "edit,share" using the client-UI
        Then user "Carol King" should be listed in the collaborators list for file "Shares/FOLDER" with permissions "edit,share" on the client-UI
        And user "Carol King" should be listed in the collaborators list for file "Shares/textfile.txt" with permissions "edit,share" on the client-UI
    ...
    Scenario: try to reshare a file/folder shared without share permission
        ...
        And user "Alice" has shared file "textfile.txt" on the server with user "Brian" with "read" permissions
        And user "Brian" has set up a client with default settings
        When the user opens the sharing dialog of "Shares/FOLDER" using the client-UI
        ...
        When the user opens the sharing dialog of "Shares/textfile.txt" using the client-UI
        Then the error text "The file can not be shared because it was shared without sharing permission." should be displayed in the sharing dialog
    ...
    Scenario: unshare a reshared file
        ...
        And user "Brian" has shared folder "Shares/textfile.txt" on the server with user "Carol"
        And user "Brian" has set up a client with default settings
        When the user unshares the resource "Shares/textfile.txt" for collaborator "Carol King" using the client-UI
        Then the text "The item is not shared with any users or groups" should be displayed in the sharing dialog
